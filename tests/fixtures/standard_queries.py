...
STANDARD_TEST_QUERIES: List[Dict] = [
    ...
    },
    {
        ...
        "expected_intent": "error_code",
        "min_confidence": 0.5,
        "must_contain": ["error", "E06"],
        "must_not_contain": [],
        "description": "Error code meaning query - E06 tool communication error",
        "category": "basic",
        "expect_idk": False,
        "max_response_time_ms": 60000
    },
    ...
    {
        "id": "GEN_001",
        "query": "What are the main features of this tool?",
        "product": "6151659030",
        "language": "en",
        "expected_intent": "specification",
        "min_confidence": 0.5,
        "must_contain": ["torque"],
        "must_not_contain": [],
        "description": "General features and specifications query",
        "category": "basic",
        "expect_idk": False,
        "max_response_time_ms": 60000
    },
    {
        ...
        "min_confidence": 0.5,
        "must_contain": ["WiFi", "wireless"],
        "must_not_contain": [],
        "description": "WiFi capability query for battery tool",
        "category": "basic",
        "expect_idk": False,
        "max_response_time_ms": 60000
    },
